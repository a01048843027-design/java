...
public class SideMenuPanel extends JPanel {
    private JButton btnDashboard, btnCourseMgmt, btnCalendar, btnAttendance, btnLogout;
    ...
    public SideMenuPanel() {
        ...
        btnAttendance = createMenuButton("출석 관리");
    ...
    public void addCalendarListener(ActionListener l) { btnCalendar.addActionListener(l); }
    public void addAttendanceListener(ActionListener l) { btnAttendance.addActionListener(l); }
